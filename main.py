...
phone_label = tkinter.Label(frame, text="Contact No.")
...
desc_label = tkinter.Label(frame, text="Product Name")
desc_label.grid(row=2, column=1)
desc_entry = tkinter.Entry(frame)
desc_entry.grid(row=3, column=1)

price_label = tkinter.Label(frame, text="Price in $")
...
columns = ('qty', 'product', 'price', 'total')
